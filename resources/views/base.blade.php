                            ...
                            <div class="widget-content-left">
                                <div class="btn-group">
                                    <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                       class="p-0 btn">
                                        <img width="42" class="rounded-circle" src="{{ asset('images/user.png') }}" alt="">
            ...
            <div class="scrollbar-sidebar">
                <div class="app-sidebar__inner">
                    <ul class="vertical-nav-menu">
                        ...
                        <li class="app-sidebar__heading">Pubs</li>
                        <li>
                            <a href="/pubs">
                        ...
                        <li class="app-sidebar__heading">Autres</li>
                        <li>
                            <a href="/suggestions">
                            ...
                            <a href="/signalement">
                                <i class="metismenu-icon pe-7s-attention">
                                </i>Signalement
                            </a>
                        </li>
                       ...
                       {{-- <li>
                        ...
                        <li class="app-sidebar__heading">Suggestions</li>
                        <li>
                            <a href="suggestions">
